...
setup(
    ...
    version=find_version('dirscan/__init__.py'),  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='Directory traverser',  # Optional
    ...
    long_description=read('README.rst'),  # Optional
    ...
    url='https://github.com/sveinse/dirscan',  # Optional
    ...
    # larger catalog.
    keywords='utility, directory, filesystem, scanner',  # Optional
    ...
    #
    packages=find_packages(where='dirscan'),  # Required
